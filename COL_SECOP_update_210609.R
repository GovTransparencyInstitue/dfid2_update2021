...
# 
# df_old <- readr::read_csv("CO_mod0129.csv")

df_old <- read.csv("CO_mod0129.csv") #This avoids prior parsing errors!
...
#Tender Bidder Deadline Table
table(is.na(df_update$tender_biddeadline))
